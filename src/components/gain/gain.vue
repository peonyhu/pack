<template>
  <div id="aa">
    <!--<component :is="currentView" activityBtn="查看活动红包" :errormsg="msg" v-if="show"></component>-->
    <!--<errormsg activityBtn="查看活动红包" :errormsg="msg" v-if="show"></errormsg>-->
    <!--局部组件-->
    ...
    <div class="m-index" ref="index1">
      ...
      <div class="m-con">
        <div class="m-home">
          <span class="m-gain"><span class="m-des mt196">好友<em class="c_fff445">{{friname}}</em>向您赠送</span></span>
...
<script type="text/ecmascript-6">
  ...
  //  import errormsg from '@/components/gain/errormsg';
...
//        currentView: errormsg,
    ...
    methods: {
      toAlertHeight: function (height) { // myHeight事件触发调用的方法
        this.objectStyle.offsetHeight = height; // message就是子组件穿过来的内容
      },
      toAlertWidth: function (width) { // myWidth事件触发调用的方法
        this.objectStyle.offsetWidth = width; // message就是子组件穿过来的内容
      },
      mobileBlur () {
        if (this.oMobileVal == '') {
